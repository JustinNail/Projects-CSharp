...
{
	public abstract partial class BaseGameScreen : GameScreen
	{
		...
		protected BaseGameScreen TransitionTo;//State to change to
		...
		public BaseGameScreen(Game game, GameScreenManager manager)
			: base(game, manager)
		{
			GameRef = (Game1)game;
		...
		public virtual void Transition(ChangeType change, BaseGameScreen gameState)
		{
			Transitioning = true;
			changeType = change;
